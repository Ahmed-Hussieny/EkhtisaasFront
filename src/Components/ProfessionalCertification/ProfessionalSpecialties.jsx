...
const ProfessionalSpecialties = ({Type,TypeIcon,id,Img,Title,Desc}) => {
  ...
  return (
    ...
    <div onClick={()=>navigate(`/ProfessionalCertificationSubSpecialties/${id}`)} className='rounded-4  d-flex align-items-center  text-center position-relative ' style={{height:'250px',backgroundColor:'rgba(247, 247, 247, 1)'}}>
        <div className='text-center  m-auto' ><img style={{height:'200px'}} src={Img} className='m-auto w-75'   alt='img1'/></div>
