...
import { HandelAddAdvisor } from "../../../store/AdvisorSlice";
...
const AddAdvisors = () => {
  ...
  async function AddCertificate(val) {
    ...
    formdata.append("contentcareer",formik.values.contentcareer)
    formdata.append("PriceOfCareerCounselingSession",formik.values.PriceOfCareerCounselingSession)
    ...
    const res = await dispatch(HandelAddAdvisor(formdata))
