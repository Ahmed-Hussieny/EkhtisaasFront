...
const OTP = () => {
    ...
    const validationSchema = YUP.object({
        otp: YUP.string().required("حقل مطلوب"),
      });
      ...
      useEffect(()=>{
        ...
        setErrorMessage("تم إنشاء OTP بنجاح، يرجى التحقق من بريدك الإلكتروني")
      },[])
      useEffect(() => {
        if (timeLeft === 0) {
          return;
    ...
    <div className='container'>
        ...
        <div className={[style.loginFormContainer, "col-md-6"].join(" ")}>
          ...
          <div className="w-75 m-auto text-center">
            <h6 className={[style.h6,"mb-3"].join(" ")}> هل نسيت كلمة المرور؟</h6>
            <p className={style.forgetP}>أدخل الكود المكون من 6 ارقام المُرسل الي بريدك الالكتروني </p>
            {ErrorMessage ? (
...
/>
        ...
        {/* timeLeft */}
           ...
           <p>
            اعادة ارسال خلال <span>{timeLeft}</span> ثانية
