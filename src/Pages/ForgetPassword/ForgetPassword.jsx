...
const ForgetPassword = () => {
    ...
    const validationSchema = YUP.object({
        email: YUP.string().email("الرجاء ادخال بريد الكتروني صحيح").required("حقل مطلوب"),
      });
    ...
    <div className='container '>
        ...
        <div className={[style.loginFormContainer, "col-md-6"].join(" ")}>
          ...
          <div className="w-75 m-auto">
            <h6 className={[style.h6,"mb-4"].join(" ")}> هل نسيت كلمة المرور؟</h6>
            <p className={style.forgetP}>ادخل البريد الالكتروني الخاص بك حتي تتمكن من اعادة تعيين كلمة المرور</p>
            {ErrorMessage ? (
